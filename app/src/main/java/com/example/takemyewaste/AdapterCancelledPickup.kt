...
class AdapterCancelledPickup: RecyclerView.Adapter<AdapterCancelledPickup.HolderCategory> {

    private  val context: Context
    public var pickupStatusArrayList:ArrayList<ModelPickUp>
    private var filterList: ArrayList<ModelPickUp>

    private lateinit var binding: RowCancelledPickupBinding
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HolderCategory {
        binding = RowCancelledPickupBinding.inflate(LayoutInflater.from(context), parent, false)

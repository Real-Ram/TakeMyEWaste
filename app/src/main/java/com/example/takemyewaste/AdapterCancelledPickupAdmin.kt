...
import com.example.takemyewaste.databinding.RowCancelledPickupAdminBinding
...
class AdapterCancelledPickupAdmin: RecyclerView.Adapter<AdapterCancelledPickupAdmin.HolderCategory> {

    private  val context: Context
    public var pickupStatusArrayList:ArrayList<ModelPickUp>
    private var filterList: ArrayList<ModelPickUp>

    private lateinit var binding: RowCancelledPickupAdminBinding
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HolderCategory {
        binding = RowCancelledPickupAdminBinding.inflate(LayoutInflater.from(context), parent, false)

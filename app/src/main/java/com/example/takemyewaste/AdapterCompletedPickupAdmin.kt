...
import com.example.takemyewaste.databinding.RowCompletedPickupAdminBinding
...
class AdapterCompletedPickupAdmin: RecyclerView.Adapter<AdapterCompletedPickupAdmin.HolderCategory> {

    private  val context: Context
    public var pickupStatusArrayList:ArrayList<ModelPickUp>
    private var filterList: ArrayList<ModelPickUp>

    private lateinit var binding: RowCompletedPickupAdminBinding
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HolderCategory {
        binding = RowCompletedPickupAdminBinding.inflate(LayoutInflater.from(context), parent, false)

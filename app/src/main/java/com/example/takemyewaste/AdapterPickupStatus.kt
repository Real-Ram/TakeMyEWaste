...
class AdapterPickupStatus: RecyclerView.Adapter<AdapterPickupStatus.HolderCategory> {

    private  val context: Context
    public var pickupStatusArrayList:ArrayList<ModelPickUp>
    private var filterList: ArrayList<ModelPickUp>

    private lateinit var binding: RowPickupStatusBinding
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HolderCategory {
        binding = RowPickupStatusBinding.inflate(LayoutInflater.from(context), parent, false)
